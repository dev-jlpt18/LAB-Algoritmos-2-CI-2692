...
fun main(args: Array<String>) {
    ...
    println("Para ejecutar los algoritmos se realizarán ${t} intentos, la secuencia es de clase ${s} y contiene ${n} elementos")
    println("")
...
// Función que verifica si la secuencia está ordenada de manera ascendente
...
// Función que obtiene el promedio de una secuencia de números
...
// Función que obtiene la derivación estándar de una secuencia de números
...
// Función que determina cuál algoritmo Sort se usará
