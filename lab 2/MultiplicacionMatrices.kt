...
fun multiplicacionStrassen(A: Array<Array<Int>>, B: Array<Array<Int>>, N: Int): Array<Array<Int>> {
	...
	if (N == 1) {
		...
		var nuevaC = ajustarDimensionesMatriz(C,N,b)
		var nuevaN = nuevaA.size
		var A11 = obtenerSubmatriz(nuevaA, 0, 0, nuevaN/2, nuevaN/2)
		var A12 = obtenerSubmatriz(nuevaA, 0, nuevaN/2, nuevaN/2, nuevaN)
		var A21 = obtenerSubmatriz(nuevaA, nuevaN/2, 0, nuevaN, nuevaN/2)
		var A22 = obtenerSubmatriz(nuevaA, nuevaN/2, nuevaN/2, nuevaN, nuevaN)
		var B11 = obtenerSubmatriz(nuevaB, 0, 0, nuevaN/2, nuevaN/2)
		var B12 = obtenerSubmatriz(nuevaB, 0, nuevaN/2, nuevaN/2, nuevaN)
		var B21 = obtenerSubmatriz(nuevaB, nuevaN/2, 0, nuevaN, nuevaN/2)
		var B22 = obtenerSubmatriz(nuevaB, nuevaN/2, nuevaN/2, nuevaN, nuevaN)
		var S1 = sumaMatricesCuadradas(B12, B22, nuevaN/2, false)
		var S2 = sumaMatricesCuadradas(A11, A12, nuevaN/2, true)
		var S3 = sumaMatricesCuadradas(A21, A22, nuevaN/2, true)
		var S4 = sumaMatricesCuadradas(B21, B11, nuevaN/2, false)
		var S5 = sumaMatricesCuadradas(A11, A22, nuevaN/2, true)
		var S6 = sumaMatricesCuadradas(B11, B22, nuevaN/2, true)
		var S7 = sumaMatricesCuadradas(A12, A22, nuevaN/2, false)
		var S8 = sumaMatricesCuadradas(B21, B22, nuevaN/2, true)
		var S9 = sumaMatricesCuadradas(A11, A21, nuevaN/2, false)
		var S10 = sumaMatricesCuadradas(B11, B12, nuevaN/2, true)
		var P1 = multiplicacionStrassen(A11, S1, nuevaN/2)
		var P2 = multiplicacionStrassen(S2, B22, nuevaN/2)
		var P3 = multiplicacionStrassen(S3, B11, nuevaN/2)
		var P4 = multiplicacionStrassen(A22, S4, nuevaN/2)
		var P5 = multiplicacionStrassen(S5, S6, nuevaN/2)
		var P6 = multiplicacionStrassen(S7, S8, nuevaN/2)
		var P7 = multiplicacionStrassen(S9, S10, nuevaN/2)
		var TMP = sumaMatricesCuadradas(P5, P4, nuevaN/2, true)
		var TMP2 = sumaMatricesCuadradas(P6, P2, nuevaN/2, false)
		var C11 = sumaMatricesCuadradas(TMP, TMP2, nuevaN/2, true)
		var C12 = sumaMatricesCuadradas(P1, P2, nuevaN/2, true)
		var C21 = sumaMatricesCuadradas(P3, P4, nuevaN/2, true)
		TMP = sumaMatricesCuadradas(P5, P1, nuevaN/2, true)
		TMP2 = sumaMatricesCuadradas(P3, P7, nuevaN/2, true)
		var C22 = sumaMatricesCuadradas(TMP, TMP2, nuevaN/2, false)
		asignarSubmatriz(nuevaC, C11, 0, 0)
		asignarSubmatriz(nuevaC, C12, 0, nuevaN/2)
		asignarSubmatriz(nuevaC, C21, nuevaN/2, 0)
		asignarSubmatriz(nuevaC, C22, nuevaN/2, nuevaN/2)
		var productoC = obtenerSubmatriz(nuevaC,0,0,N,N)
		return productoC
	}
}
 ...
 */
fun ajustarDimensionesMatriz(A: Array<Array<Int>>, N: Int, b: Boolean): Array<Array<Int>> {
	if (b == true) {
		return A
	} else {
...
// Función que asigna ua submatriz B en una matriz A
...
fun medirTiempoAjustar(A: Array<Array<Int>>): Double {
	var tInicio: Long = System.currentTimeMillis()
	ajustarDimensionesMatriz(A, A.size, esPotenciaDeDos(A.size))
	var tFinal: Long = System.currentTimeMillis()
	var tiempo: Double = ((tFinal- tInicio)/1000.0).toDouble()
	return tiempo
}
